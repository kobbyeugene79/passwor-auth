...
<template>
    ...
    <div class="status">
        <p v-if="passwordProp === 0" class="status__name">Weak 
        ...
        <p v-else-if="passwordProp === 1" class="status__name">Meduim 
        ...
        <p v-else-if="passwordProp === 2" class="status__name">Strong 
        ...
        <p v-else-if="passwordProp >= 3" class="status__name">Strongest 
            <span class="status__color status__color--strong animate1"></span>
            <span class="status__color status__color--strong animate2"></span>
            <span class="status__color status__color--strong animate3"></span>
